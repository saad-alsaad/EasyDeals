...
require "../Info/dealer_identification.php";
 require "notification_processes.php" ?>
<!DOCTYPE html>
<html>
                    ...
                    ?>
                        ...
                        <div class="form-group col-lg-12 Form_Group Edges">
                            <form action="Notifications.php" method="post">
                                <div class="col-lg-3">
                                    <input type="text" class="form-control" list="live_search" name="search_word" id="word" placeholder="بــحــــث" onkeyup='state(this.value,"fetch_notifications.php")'>
                        ...
                        <div class='form-group col-sm-12 Record_Group Edges' style='padding-bottom: 6px;'>
                            <div class='col-lg-4'>";
                                echo '<input class="form-control" style="resize: none; height: 35px; overflow:hidden;" value="'.$output[1][$i].'">';
                            echo "</div>";
                                if($output[3][$i] == '3'){
                                    echo "
                                <div class='col-lg-2'>
