<?php
session_start();
include "../Info/dealer_identification.php";
include "db.php";
$output = array();
$output1 = array();
...
$query1 = "SELECT bills.value,bills.Bill_id,bills.Maturity_D FROM bills WHERE  bills.dealer_id = '$_SESSION[id]' AND bills.active=1   ORDER BY bills.Creation_date DESC LIMIT 5";
...
for($i = 0;$row1 = mysqli_fetch_assoc($result1);$i++){
    ...
    $output1[2][$i] = $row1['value'];


        $output1[3][$i] = $row1['Maturity_D'];
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default Edges">
                                    <div class="panel-heading Edges">
                                        <a href="Bills.php"><i class="glyphicon glyphicon-usd"></i></a>اخر الفواتير
                                    </div>
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <?php for($j = 0; $j < count($output1[0]);$j++){ ?>
                                                    <tr>
                                                        <td><a href="Bills.php"><?php echo $output1[0][$j]; ?></a></td>
