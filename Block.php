        ...
        <section class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <center><h4>حـــظـــر</h4></center>
                </div>
                <div class="panel-body">
                    <p>
                        الـرجـاء عـدم إسـتـخـدام شـبـكـات خـاصـة (مثل: VPN أو Proxy) <br> لـلـتـمـتـع بـخـدمـة Easy Deals يـرجـى الغاء إتـصـالـك بالـشـبـكـات الـخـاصـة وإعـادة تـحـديـث الـصـفـحـة
                    </p>
                </div>
            </div>
        </section>
